...
public class Server {
	...
	public Server(final int port, final int nThreads, final String clusterName) {
		this.port = port;
	...
	public static void main(final String[] args) {
		...
		new Server(port, nThreads, clusterName).start();
	}
	...
	private void start() {
		...
		try {
			...
			if (clusterName != null) {
				impl.join(clusterName);
				System.out.println("Node joining cluster");
			}
